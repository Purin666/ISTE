...
inline static T StringCast(const U&)
{
	return nullptr;
}

template<>
inline std::wstring StringCast<std::wstring>(const std::string& someString)
{
...
template<>
inline std::string StringCast<std::string>(const std::wstring& someString)
{
...
template<>
inline std::wstring StringCast<std::wstring>(const char* someString)
{
...
template<>
inline std::string StringCast<std::string>(const wchar_t* someString)
{
